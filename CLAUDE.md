...
ray firewall suggest <net> --subject H [--allow peer:ports] [--deny peer:ports] [--default deny]  # coordinator-only: suggest rules to a trusted network (rides the signed blob)
